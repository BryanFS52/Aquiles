              ...
              <form onSubmit={handleLogin}>
                <div className="flex flex-col items-center">
                  <div className="flex items-center w-full mt-4 rounded border-solid border-2">
                    <HiMiniIdentification className="w-6 mr-2 mx-3 h-5 text-gray-500" />
                    <select
                      name="documentType"
                  ...
                  <div className="flex items-center w-full mt-4 rounded border-solid border-2 text-custom-blue">
                    <BsPersonCircle className="w-6 mr-2 mx-3 h-5 text-gray-500" />
                    <input 
                  ...
                  <div className="flex items-center w-full mt-4 rounded border-solid border-2">
                    <HiLockClosed className="w-6 mr-2 mx-3 h-5 text-gray-500" />
                    <input 
                ...
                <div className="flex justify-between mt-4 items-center text-custom-blue">
                  <div className="flex text-center">
                    ...
                    <label htmlFor="" className='text-sm'>Recordar</label>
                  </div>
