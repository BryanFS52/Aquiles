    ...
    return(
        ...
        <div className="min-h-screen grid grid-cols-1 xl:grid-cols-6">
            ...
            <div className="h-[90vh] overflow-y-scroll p-12 inline-block w-full">
                <h1 className="text-[#0e324d] text-2xl sm:text-3xl lg:text-4xl pb-3 border-b-2 border-gray-400 w-full sm:w-3/4 lg:w-1/2 mb-6 lg:mb-12 font-inter font-semibold"> Mi Asistencia</h1>
                ...
                <div className="flex bg-custom-blue w-full h-14">
                    <h1 className="text-green-600 font-inter font-semibold text-3xl pt-3 ml-6">Junio</h1>
                        ...
                        <form className="w-72 h-10 ml-24 pt-3">
                            <div className="relative">
                                ...
                                <input type="search" className="font-inter font-normal h-8 block w-52 pl-10 pr-10 text-sm rounded-lg dark:bg-white border-2 border-slate-300 dark:placeholder-gray-400 dark:text-black focus:outline-none focus:border-slate-300" placeholder="Filtrar por"/>
