    ...
    return (
        ...
        <div className="xl:col-span-5">
            ...
            <div className="flex pt-5">
              ...
              <div className="font-inter font-normal text-black sm:text-base ml-auto relative w-2/3">
                <input type="text" name="nameProject" placeholder="Apellidos del Aprendiz" className=" w-72  rounded-lg border-gray-300 border-2 pl-3 ml-6 pr-10"  value={apellidosAprendiz}
            ...
            <div className="flex pt-5">
                <button type="submit" className="bg-custom-blue border-2 border-custom-blue rounded-xl text-white font-medium font-inter text-base w-44 h-8 ml-72 cursor-pointer">Agregar Aprendiz</button>
            </div>
            </div>
            </div>
            </div>
