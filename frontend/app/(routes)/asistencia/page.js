    ...
    return (
        <div className="min-h-screen grid grid-cols-1 xl:grid-cols-6">
            ...
            <div className="xl:col-span-5">
                ...
                <div className="min-h-screen p-4 md:p-8 lg:p-12 w-full bg-neutral-100 space-y-5">
                    ...
                    <div className="flex flex-col space-y-4 md:flex-row md:space-x-10 md:space-y-0 justify-center w-full">
                        <div className="flex h-auto md:h-16 w-full md:w-[30%] rounded-lg shadow-lg bg-white border-2 border-gray-300 p-4">
                            <div className="flex items-center justify-center md:justify-start w-full">
                                <span className="font-inter font-medium text-xl text-green-500 text-center">
                        ...
                        <div className="flex h-auto md:h-16 w-full md:w-[38%] rounded-lg shadow-lg bg-white border-2 border-gray-300 p-4">
                            <div className="flex flex-col items-center justify-center space-y-4 w-full md:flex-row md:justify-start md:space-y-0 md:space-x-14">
