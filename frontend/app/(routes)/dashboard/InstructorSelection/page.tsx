              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {selectedStudySheet.teamsScrum?.map((teamScrum) => (
                    <div
                      ...
                      className={`bg-white dark:bg-gray-800 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer group p-6 border ${selectedTeamScrum?.id === teamScrum.id
                    ...
                    >
                      <div className="text-center">
                        {/* Círculo con ícono */}
                        <div className="mb-6">
                          <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto ${selectedTeamScrum?.id === teamScrum.id
                ...
                <div className="flex justify-between items-center mt-8">
                  ...
                  <button
                    ...
                    className={`px-6 py-3 rounded-lg font-medium transition-colors ${selectedTeamScrum
