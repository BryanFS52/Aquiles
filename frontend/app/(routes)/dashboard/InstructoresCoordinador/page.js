        ...
        <div className="min-h-screen grid grid-cols-1 xl:grid-cols-6">
            <div className="xl:col-span-5">
                <main className="container mx-auto p-6">
                    <h1 className="text-black dark:text-white text-3xl lg:text-4xl pb-3 border-b-2 border-gray-300 dark:border-gray-600 w-full sm:w-3/4 lg:w-1/2 font-inter font-semibold transition-colors duration-300 mb-6">Instructores</h1>
