...
function CompetenceSelectionPageContent() {
...
const InstructorFollowUpPage = () => (
  <CompetenceSelectorContainer
    title="Seleccionar Competencia para Seguimiento"
    baseRoute="/dashboard/InstructorFollowUp"
  />
);
  ...
  return (
    <Suspense fallback={<div className="flex items-center justify-center min-h-screen">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">Cargando competencias...</p>
      </div>
    </div>}>
      <CompetenceSelectionPageContent />
    </Suspense>
  );
}
