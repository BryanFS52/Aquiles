...
import { TeamsScrum, Profile } from "@graphql/generated";
import { MdAddCircle, MdInfo, MdGroup } from "react-icons/md";
import { useLoader } from "@context/LoaderContext";
import { ModalComposition } from "@components/Modals/modalComposition";
...
export default function TeamScrumDetailsPage() {
    ...
    const { data: processMethodologies } = useSelector(
        (state: RootState) => state.processMethodologies
    );
    ...
    const [, setOpenAddInfoModal] = useState<boolean>(false);
    ...
    }, [studySheetLoading, showLoader, hideLoader, isInitialLoad]);
    ...
    return (
        <div className="min-h-screen p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Mostrar mensaje de carga solo durante la carga inicial */}
                {isInitialLoad && studySheetLoading && (
