    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        {(studySheets as StudySheet[]).map((sheet) => (
          ...
          >
            <div className="w-full h-full rounded-xl sm:rounded-2xl overflow-hidden bg-white dark:bg-shadowBlue hover:shadow-lg dark:hover:bg-darkBlue transition-all duration-300 border border-lightGray dark:border-grayText flex flex-col cursor-pointer transform hover:-translate-y-1 hover:scale-[1.02] relative min-h-[400px] sm:min-h-[450px]">
              ...
              <div className="relative p-4 sm:p-6 pb-3 sm:pb-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4">
                  <div className="bg-gradient-to-r from-primary to-lightGreen dark:from-secondary dark:to-darkBlue text-white px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-bold text-center sm:text-left">
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-gray-50 dark:bg-shadowBlue/50 rounded-lg p-3 sm:p-4">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-xs sm:text-sm font-medium text-grayText dark:text-white">Programa</span>
                    </div>
                    <p className="font-semibold text-black dark:text-white text-sm sm:text-base lg:text-lg leading-tight">
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:gap-3">
                    <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                      ...
                      <span className="text-xs sm:text-sm text-black dark:text-white font-semibold text-right">
                        {sheet.journey?.name ?? "Sin jornada"}
                      </span>
                    </div>

                    <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                      <span className="text-xs sm:text-sm text-grayText dark:text-white font-medium">Oferta</span>
                      <span className="text-xs sm:text-sm text-black dark:text-white font-semibold text-right">
                    ...
                    <div className="flex items-center justify-between py-2 border-b border-gray-100 dark:border-gray-700">
                      <span className="text-xs sm:text-sm text-grayText dark:text-white font-medium">Trimestre</span>
                      <span className="text-xs sm:text-sm text-black dark:text-white font-semibold text-right">
                        {(() => {
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 space-y-2">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-400">Período Lectivo</span>
                      </div>
              ...
              <div className="relative px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 dark:bg-shadowBlue/30 border-t border-gray-200 dark:border-darkGreen/50 mt-auto">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-r from-primary to-lightGreen dark:from-secondary dark:to-darkBlue rounded-full flex items-center justify-center">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                      </svg>
                    </div>
                    <span className="text-xs sm:text-sm font-semibold text-gray-600 dark:text-white">
                      {sheet.numberStudents} Aprendices
                    </span>
                  </div>
                  <div className="flex items-center space-x-1 sm:space-x-2 text-black dark:text-white group-hover:translate-x-1 transition-transform">
