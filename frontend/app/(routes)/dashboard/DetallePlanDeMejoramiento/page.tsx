		...
		const load = async () => {
			...
			try {
				const [pRes, aRes] = await Promise.all([
					client.query({ query: GET_IMPROVEMENT_PLAN_BY_ID, variables: { id: planId }, fetchPolicy: "no-cache" }),
					client.query({ query: GET_ALL_IMPROVEMENT_PLAN_ACTIVITIES, variables: { id: planId, page: 0, size: 200 }, fetchPolicy: "no-cache" }),
				]);
									...
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
										...
										<div className="bg-gradient-to-br from-gray-50 to-white dark:from-slate-800 dark:to-slate-900 rounded-xl p-5 border border-gray-200 dark:border-slate-700">
											<div className="flex items-start justify-between mb-3">
												...
												<div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${evaluation.pertinence
											...
											<span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold border ${evaluation.pertinence
										...
										<div className="bg-gradient-to-br from-gray-50 to-white dark:from-slate-800 dark:to-slate-900 rounded-xl p-5 border border-gray-200 dark:border-slate-700">
											<div className="flex items-start justify-between mb-3">
												...
												<div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${evaluation.validity
														? 'bg-emerald-100 dark:bg-emerald-500/20'
														: 'bg-red-100 dark:bg-red-500/20'
													}`}>
													{evaluation.validity ? (
											...
											<span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold border ${evaluation.validity
													? 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30'
													: 'bg-red-50 text-red-700 border-red-200 dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/30'
												}`}>
										...
										<div className="bg-gradient-to-br from-gray-50 to-white dark:from-slate-800 dark:to-slate-900 rounded-xl p-5 border border-gray-200 dark:border-slate-700">
											<div className="flex items-start justify-between mb-3">
												...
												<div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${evaluation.authenticity
														? 'bg-emerald-100 dark:bg-emerald-500/20'
														: 'bg-red-100 dark:bg-red-500/20'
													}`}>
											...
											<span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold border ${evaluation.authenticity
													? 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30'
													: 'bg-red-50 text-red-700 border-red-200 dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/30'
												}`}>
										...
										<div className="bg-gradient-to-br from-gray-50 to-white dark:from-slate-800 dark:to-slate-900 rounded-xl p-5 border border-gray-200 dark:border-slate-700">
											<div className="flex items-start justify-between mb-3">
												...
												<div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${evaluation.quality
														? 'bg-emerald-100 dark:bg-emerald-500/20'
														: 'bg-red-100 dark:bg-red-500/20'
													}`}>
													{evaluation.quality ? (
											...
											<span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold border ${evaluation.quality
													? 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/30'
													: 'bg-red-50 text-red-700 border-red-200 dark:bg-red-500/10 dark:text-red-400 dark:border-red-500/30'
												}`}>
										...
										<div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-5 border-2 border-emerald-200 dark:border-blue-500/30 md:col-span-2 lg:col-span-1">
											<div className="flex items-start justify-between mb-3">
												...
												<div className={`flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${evaluation.judgment
											...
											<span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-bold border-2 ${evaluation.judgment
