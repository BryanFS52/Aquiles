              ...
              <table className="min-w-full divide-y divide-gray-200 border border-gray-200 table-auto">
                <thead className="bg-sky-950">
                  <tr>
                    ...
                    <th className="px-4 w-96 border-2 border-gray-300 bg-sky-950 text-sm font-semibold text-white text-center">
                      Número de Identificación
                    </th>
                    <th className="px-4 w-96 border-2 border-gray-300 bg-sky-950 text-sm font-semibold text-white text-center">
                      Programa
                    </th>
                    <th className="px-4 w-20 border-2 border-gray-300 bg-sky-950 text-sm font-semibold text-white">
                      Nombres
                    </th>
                    <th className="px-4 w-20 border-2 border-gray-300 bg-sky-950 text-sm font-semibold text-white">
                      Apellidos
                    </th>
                    <th className="px-4 border-2 border-gray-300 bg-sky-950 text-sm font-semibold text-white">
