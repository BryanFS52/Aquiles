                            ...
                            <div className="flex flex-col items-start space-y-4">
                                <div>
                                    ...
                                    <div className="relative inline-block ml-8">
                                        <input type="text" className="border-2 border-gray-300 rounded-lg ml-4 w-52"/>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative inline-block ml-8">
                                        <select className="border-2 border-gray-300 rounded-lg mr- w-52">
                                        <option value=""> </option> 
                            ...
                            <div className="flex flex-col items-start space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative inline-block ml-10">
                                        <select className="border-2 border-gray-300 rounded-lg ml-6 w-52">
                                        <option value=""> </option> 
                                            {team.map((team, index) => (
                                ...
                                <div>
                                    ...
                                    <div className="relative inline-block ml-16">
                                        <select className="border-2 border-gray-300 rounded-lg ml-1 w-52">
                                        <option value=""> </option> 
                                ...
                                <div className="pt-1">
                                    <button className="bg-custom-blue text-white text-center font-bold py-2 px-4 rounded-lg mt-4 block ml-3 w-28 h-10">Buscar</button>
                                </div>
                            </div>
