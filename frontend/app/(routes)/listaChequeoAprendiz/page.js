        ...
        <div className="min-h-screen grid grid-cols-1 xl:grid-cols-6">
            ...
            <div className="xl:col-span-5">
                ...
                <div className="flex space-x-3 mt-10">
                    <div className="w-52 h-52 rounded-lg overflow-hidden shadow-lg border-2 border-gray-300 relative p-4 ml-52">
                    ...
                    <div className="flex flex-col">
                        <div className="w-44 h-15 rounded-lg overflow-hidden shadow-lg border-2 border-gray-300 relative p-4 mb-3">
                    ...
                    <div className="flex flex-col space y-4">
                        <div className="w-60 h-15 rounded-lg overflow-hidden shadow-lg border-2 border-gray-300 relative p-4 mb-3">
                        ...
                        <div className="w-60 h-15 rounded-lg overflow-hidden shadow-lg border-2 border-gray-300 relative p-4">
                            <h1 className="font-inter text-xl text-green-500 font-semibold pb-2">Indicador:</h1>
                            <span className="font-inter text-base text-custom-blue font-medium">s</span>
                        </div>
                    </div>
