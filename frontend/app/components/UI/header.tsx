...
export const Header: React.FC<HeaderProps> = ({ role: initialRole }) => {
  ...
  return (
    <header className="h-[60px] sm:h-[7vh] md:h-[10vh] w-full flex items-center bg-gradient-to-r from-[#5cb800] to-[#8fd400] dark:from-secondary dark:to-blue-900 px-2 md:px-6 overflow-hidden">
