                                            ...
                                            <React.Fragment key={weekIndex}>
                                                {[...Array(7)].map((_, dayIndex) => {
                                                    ...
                                                    const getCellClassName = (value: string): string => {
                                                        switch (value) {
                                                            case '✓': return 'text-lightGreen dark:text-blue-400 font-bold';
                                                            case 'R': return 'text-yellow-500 dark:text-yellow-400 font-bold';
                                                            case 'X': return 'text-red-500 dark:text-red-400 font-bold';
                                                            case 'J': return 'text-blue-500 dark:text-blue-400 font-bold';
                                                            default: return 'text-darkGray dark:text-gray-400';
                                                        }
                                                    };
                                                    ...
                                                    return (
                                                        <td
                                                            key={dayIndex}
                                                            className="px-0.5 sm:px-1 py-1.5 sm:py-2 border border-lightGray dark:border-gray-600 text-center text-xs sm:text-sm bg-white dark:bg-gray-800"
                                                        >
