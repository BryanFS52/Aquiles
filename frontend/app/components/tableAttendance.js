                ...
                <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-4 w-full">
                    ...
                    {alertVisible && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -10 }}
                            className="absolute z-10 left-0 top-10 mt-4 bg-white border-2 border-gray-400 shadow-lg h-20 rounded-lg flex items-center justify-center p-4 w-[90%] md:w-[300px]"
                        >
                                    ...
                                    <React.Fragment key={weekIndex}>
                                        {[...Array(7)].map((_, dayIndex) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span className={`${cellValue === '✓' ? 'text-green-500 font-bold' :
