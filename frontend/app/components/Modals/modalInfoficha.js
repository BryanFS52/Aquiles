...
const ModalInfoficha = ({ isOpen, onClose }) => {   // se crea los eventos de cerrar y abri el modal
      ...
      <div className="relative w-full max-w-3xl mx-auto my-12 bg-white rounded-lg shadow-lg">
        <div className="p-5">
          <div className='flex justify-center items-center'>
            <h1 className="text-2xl font-serif border-b-2 border-black">Información de la Ficha</h1>
          </div>
          ...
          <div className='mt-5'>
            <div className="mb-4 md:flex md:space-x-4 grid-cols-3">
              ...
              <div className="flex-1 mb-4 md:mb-0">
                ...
                <input type="text" placeholder='Seleccionar Ficha' className="rounded-md bg-white border-gray-300 shadow-md border-2 w-full md:w-56 px-3 py-2" />
              </div>
              <div className="flex-1 mb-4 md:mb-0">
                <label className="font-serif text-lg mb-1 block">Jornada</label>
                <input type="text" placeholder='Seleccionar Jornada' className="rounded-md bg-white border-gray-300 shadow-md border-2 w-full md:w-56 px-3 py-2" />
              </div>

              <div className="flex-1">
                <label className="font-serif text-lg mb-1 block">Fase</label>
                <input type='text' placeholder='Seleccionar Fase' className="rounded-md bg-white border-gray-300 shadow-md border-2 w-full md:w-56 px-3 py-2" />
              </div>
            </div>
            ...
            <div className="mb-4 md:flex md:space-x-4 grid-cols-3">
              ...
              <div className="flex-1">
                <label className="font-serif text-lg mb-1 block">Instructor Tecnico</label>
                <input type='text' placeholder='Instructor Tecnico' className="rounded-md bg-white border-gray-300 shadow-md border-2 w-full md:w-56 px-3 py-2" />
              </div>
              <div className="flex-1 mb-4 md:mb-0">
            ...
            <div className="mb-4 md:flex md:space-x-4 ml-56">
              <div className="flex-1 mb-4 md:mb-0 ml-7">
                <label className="font-serif text-lg mb-1 block">Instructor</label>
                <input type="text" placeholder='Seleccione el Instructor' className="rounded-md bg-white border-gray-300 shadow-md border-2 w-full md:w-56 px-3 py-2" />
              </div>
