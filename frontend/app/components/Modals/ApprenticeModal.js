    ...
    <div className="border rounded-lg p-4 shadow-md">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h3 className="text-lg font-semibold">{apprentice.name} {apprentice.lastName}</h3>
          <p className="text-sm text-gray-500">Documento: {apprentice.document}</p>
        </div>
        <span className={`text-white px-2 py-1 rounded ${statusColor[apprentice.status]}`}>{apprentice.status}</span>
      </div>
      <div className="mt-2">
