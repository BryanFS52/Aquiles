...
public class JustificationResolver {
    ...
    // JustificationAndStudySheetById Justifications (GraphQL)
    @DgsQuery
    public Map<String, Object> justificationAndStudySheetById(@InputArgument Integer page, @InputArgument Integer size) {
        try {
            ...
            return ResponseHttpApi.responseHttpError(
                    "Error retrieving JustificationAndStudySheetById: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
