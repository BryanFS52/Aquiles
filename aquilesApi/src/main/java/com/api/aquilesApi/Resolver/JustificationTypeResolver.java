...
public class JustificationTypeResolver {
    ...
    public Map<String, Object> allJustificationTypes(@InputArgument Integer page, @InputArgument Integer size) {
        try {
            ...
            return ResponseHttpApi.responseHttpError(
                    "Error retrieving JustificationTypes: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public Map<String, Object> justificationTypeById(@InputArgument Long id) {
        try {
            ...
            return ResponseHttpApi.responseHttpError(
                    "Error retrieving JustificationType: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR
            );
        }
    }
