...
@DgsComponent
public class ImprovementPlanStudentData {

    private final ModelMapper modelMapper;

    public ImprovementPlanStudentData(ModelMapper modelMapper) {
        this.modelMapper = modelMapper;
    }

    @DgsData(field = "student", parentType = "ImprovementPlan")
    public Map<String, Object> getStudent(DgsDataFetchingEnvironment env){
        try {
            ...
            if (improvementPlan.getStudentId() == null) {
                return null;
            }
            return Map.of("id", improvementPlan.getStudentId().toString());
        } catch (Exception e) {
            e.printStackTrace();
