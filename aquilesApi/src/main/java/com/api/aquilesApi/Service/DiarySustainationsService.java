...
public class DiarySustainationsService implements Idao<DiarySustainationsEntity, Long> {
    private final DiarySustainationsRepository diarySustainationsRepository;

    public DiarySustainationsService(DiarySustainationsRepository diarySustainationsRepository) {
        this.diarySustainationsRepository = diarySustainationsRepository;
    }
