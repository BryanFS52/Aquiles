    ...
    <main className="h-screen">
      <div className=" bg-white shadow-default h-screen">
        <div className="flex flex-wrap flex-row-reverse items-center h-full">
          <div
            className=" w-full xl:block xl:w-1/2 h-full bg-cover bg-center flex flex-col items-center justify-between bg-black fondo-login"
            style={{ backgroundImage: "url('/img/fondo-login.png')" }}
          >
            <div className="flex justify-end items-center">
              <Image className="w-24" src={logoWhite} alt="logo" />
            </div>
          ...
          <div className="w-full xl:w-1/2">
            ...
            <div className="w-full px-7 sm:px-12.5 xl:px-29">
              <form className="w-3/5 container mx-auto">
                ...
                <div className="w-full flex justify-center cursor-pointer rounded-lg border border-darkBlue bg-darkBlue p-4 text-white transition hover:bg-opacity-90">
                  <Link 
                      href="/home"
                      >
                        Iniciar Sesion
